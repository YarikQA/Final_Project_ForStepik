...
class ProductPage(BasePage):
    ...
    def basket_price_equals_book_price(self):  # проверка: стоимость добавленного товара = стоимость корзины
    ...
    def book_names_are_equal(self):  # проверка, что добавлен нужный элемент
    ...
    def should_not_be_success_message(self):  # негативная проверка на наличие сообщения об успешной покупке
